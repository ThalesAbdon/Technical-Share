...
import {Card, Button, Container, Row, Col, Modal,InputGroup, FormControl} from 'react-bootstrap';
...
///////////////////////
  ...
  //cards filtrados que aparecem quando abre a tela
  const mentors =  filteredProfiles.map(mentor => (
